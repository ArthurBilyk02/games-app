...
import { GameDeveloperQueryParams } from "../shared/types";
...
const isValidQueryParams = ajv.compile(
  schema.definitions["GameDeveloperQueryParams"] || {}
);
...
export const handler: APIGatewayProxyHandlerV2 = async (event, context) => {
  try {
    ...
    const gameId = queryParams.gameId ? parseInt(queryParams.gameId) : 0;
